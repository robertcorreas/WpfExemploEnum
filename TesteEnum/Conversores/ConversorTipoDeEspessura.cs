...
namespace TesteEnum.Conversores
{
    public class ConversorTipoDeEspessura : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return Util.Util.GetEnumDescription((TipoDeEspessura) value);
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var descricaoPorTipoDeEspessura = todosOsTiposDeEspessura.ToDictionary(tipoEspessura => Util.Util.GetEnumDescription(tipoEspessura));
